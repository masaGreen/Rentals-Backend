...
public record ExceptionsObject(Date timeStamp, Map<String, String> errorsMessages, int code) {
    ...
    public static ExceptionsObject withSingleMessage(Date timeStamp, String errorMessage, int code) {
        return new ExceptionsObject(timeStamp, Collections.singletonMap("message", errorMessage), code);
    }

    public static ExceptionsObject withManyMessages(Date timeStamp, Map<String, String> errorMessages, int code) {

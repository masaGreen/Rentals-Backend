...
//                 .id(id)
//                 .email("root@gmail.com").password("password").role("ADMIN").status(false)
//                 .build();
//         signUpReqDto = new SignUpReqDto(appUser);

//     }

//     @Test
//     void saveUser() {
//         Mockito.when(appUserRepository.saveUser(signUpReqDto)).thenReturn();
